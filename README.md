...
See `PHASE\_1\_DOCUMENTATION.md` for detailed design decisions and reasoning (schema design, connection pooling, JWT auth, etc.). Updated at the end of each phase.
